        ...
        if (GameObject.FindObjectOfType<Player1LevelScript>().LevelStarted)
        {
            ...
            else if (Input.GetAxis("Horizontal P1") == 0)
            {
                ...
                if (Time.time > (timer + 0.01f))
                {
                    ...
                    if (GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles.y > 180)
                    {
                        trackback.y = -5;
                        GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles = GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles + trackback / 5;
                    }
                    if (GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles.y < 181)
                    {
                        trackback.y = 5;
                        GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles = GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles + trackback / 5;
                    }
                ...
                if (GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles.y > 195)
                {
                    //GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles = GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles - moveRot;
                    GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles = GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles = new Vector3(GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles.x, 195, GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles.z); //+ moveRot;
                }
                if (GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles.y < 165)
                {
                    GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles = GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles = new Vector3(GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles.x, 165, GameObject.Find("P1 Camera").GetComponent<Camera>().transform.localEulerAngles.z); //+ moveRot;
