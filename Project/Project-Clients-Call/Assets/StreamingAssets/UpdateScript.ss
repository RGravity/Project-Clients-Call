...
GameObject.Find("Directional light").GetComponent(Light).intensity = Mathf.Lerp(GameObject.Find("Directional light").GetComponent(Light).intensity, .3, .02);

// slowly fades in the ambient light, as it's initialized at blackness
RenderSettings.ambientLight = Color.Lerp(RenderSettings.ambientLight, Camera.main.backgroundColor, .1f);
